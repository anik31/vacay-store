...
test("should return filtered products", () => {
    ...
    const category = ["Camera"], rating = 4, priceRange = 25000, includeOutOfStock = false;
    ...
    const filteredProducts = getFilteredData(products, category, rating, priceRange, includeOutOfStock);
